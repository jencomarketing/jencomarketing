      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-black text-white mb-4 font-tech">
            我的大厨 <span className="text-brandOrange text-shadow-neon">招牌菜</span> (Works)
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="text-3xl font-black text-white mb-2 font-tech">平面设计作品集</h3>
              <p className="text-brandYellow font-bold tracking-widest text-sm uppercase mb-6 font-mono">Graphic Design Portfolio</p>
              <div className="inline-flex items-center gap-2 bg-white/10 hover:bg-brandYellow hover:text-black text-white px-6 py-3 rounded-full font-bold transition-all backdrop-blur-sm border border-white/20 group-hover:border-transparent font-tech">
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8">
              ...
              <h3 className="text-3xl font-black text-white mb-2 font-tech">视频拍摄作品集</h3>
              <p className="text-red-500 font-bold tracking-widest text-sm uppercase mb-6 font-mono">Video Production Portfolio</p>
              <div className="inline-flex items-center gap-2 bg-white/10 hover:bg-red-600 hover:text-white text-white px-6 py-3 rounded-full font-bold transition-all backdrop-blur-sm border border-white/20 group-hover:border-transparent font-tech">
                <FolderOpen size={18} /> 点击查看 (Google Drive) <ExternalLink size={14} />
              </div>
            </div>
          </a>
